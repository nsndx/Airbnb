   ...
   return (
      <div className='h-screen bg-gray-800'>
         ...
         <div className='pt-5 space-y-2'>
            ...
            <NavLink style={active} onClick={(e) => e.preventDefault()} to='quanlydatphong' className='block px-3 py-1 text-white text-base font-semibold hover:text-white hover:bg-amber-500 cursor-no-drop'>Quản lý đặt phòng</NavLink>
         </div>
      </div>
   )
}
